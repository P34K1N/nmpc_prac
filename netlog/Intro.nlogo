...
to move-turtles
  ask turtles [
    right -1 * max-angle + random (2 * max-angle)
    forward speed
    set energy energy - energy-decay
  ]
end
...
to regrow-grass
  ask patches [
    if random 100 < regrowth-prob [set pcolor green]
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
